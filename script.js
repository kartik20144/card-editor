...
//   });
document.addEventListener('DOMContentLoaded', function () {
  let selectedTextElement = null; // To keep track of the currently selected text element
  ...
  document.getElementById('addTextBtn').addEventListener('click', function () {
    ...
    // Set this new element as the selected one
  ...
  // Function to handle applying styles to the selected text only
  ...
  // Event listeners for controls to update the style of the selected text only
  document.getElementById('fontSize').addEventListener('change', function () {
    applyStyleToSelectedText('fontSize', document.getElementById('fontSize').value);
  });

  document.getElementById('fontType').addEventListener('change', function () {
    applyStyleToSelectedText('fontName', document.getElementById('fontType').value);
  });

  document.getElementById('fontColor').addEventListener('input', function () {
    applyStyleToSelectedText('foreColor', document.getElementById('fontColor').value);
  });
  ...
  function makeTextDraggable(textElement) {
    ...
    textElement.addEventListener('mousedown', function (e) {
      ...
      // Set this text element as the selected one
      selectedTextElement = textElement;
    });
  ...
  document.addEventListener('focusin', function (e) {
    if (e.target.classList.contains('draggable-text')) {
      swiper.allowTouchMove = false;
      selectedTextElement = e.target; // Set the focused element as selected
    }
  });
